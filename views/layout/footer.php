        ...
        <div class="modal-content bg-dark text-white border-secondary">
            ...
            <form onsubmit="enviarFormularioAsincrono(event, 'api/insertar_elementos.php')">
                ...
                <div class="modal-body d-flex flex-column gap-3">
                    ...
                    <div>
                        <label class="form-label text-secondary small fw-bold">Año de lanzamiento <span class="text-warning">(Opcional)</span></label>
                        <input type="number" name="anio" class="form-control bg-secondary text-white border-0" placeholder="Ej: 2026">
                    </div>
                    <div>
                        <label class="form-label text-secondary small fw-bold">Carátula del Álbum <span class="text-warning">(Opcional)</span></label>
                        <input type="file" name="caratula" class="form-control bg-secondary text-white border-0" accept="image/*">
                    </div>
                </div>
                <div class="modal-footer border-secondary">
                    <button type="submit" class="btn btn-success fw-bold w-100">Guardar Álbum</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-dark text-white border-secondary">
            ...
            <form onsubmit="enviarFormularioAsincrono(event, 'api/insertar_elementos.php')">
                ...
                <div class="modal-body d-flex flex-column gap-3">
                    <div>
                        <label class="form-label text-secondary small fw-bold">Nombre de la Lista</label>
                        <input type="text" name="nombre" class="form-control bg-secondary text-white border-0" required>
                    </div>
                    <div>
                        <label class="form-label text-secondary small fw-bold">Descripción Corta <span class="text-warning">(Opcional)</span></label>
                        <input type="text" name="descripcion" class="form-control bg-secondary text-white border-0">
                    </div>
                    <div>
                        <label class="form-label text-secondary small fw-bold">Portada Personalizada <span class="text-warning">(Opcional)</span></label>
                        <input type="file" name="caratula" class="form-control bg-secondary text-white border-0" accept="image/*">
                    </div>
                </div>
                <div class="modal-footer border-secondary">
                    <button type="submit" class="btn btn-success fw-bold w-100">Crear Playlist</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <form onsubmit="enviarFormularioAsincrono(event, 'api/editar_elementos.php')">
                ...
                <div class="modal-body d-flex flex-column gap-3">
                    ...
                    <div>
                        ...
                        <input type="hidden" name="url_imagen_online" class="hidden-url-online">
                        <div class="text-center mt-2 preview-container d-none">
                            <img src="" class="preview-img rounded border border-danger" style="width: 100px; height: 100px; object-fit: cover;">
                            <div class="small text-danger mt-1 fw-bold">Portada seleccionada</div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
            ...
            <form onsubmit="enviarFormularioAsincrono(event, 'api/editar_elementos.php')">
                ...
                <div class="modal-body d-flex flex-column gap-3">
                    ...
                    <div>
                        ...
                        <input type="hidden" name="url_imagen_online" class="hidden-url-online">
                        <div class="text-center mt-2 preview-container d-none">
                            <img src="" class="preview-img rounded-circle border border-danger" style="width: 100px; height: 100px; object-fit: cover;">
                            <div class="small text-danger mt-1 fw-bold">Foto seleccionada</div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<!-- ============================================== -->
<!-- NUEVO MODAL: GALERÍA DE BÚSQUEDA ONLINE DEEZER -->
<!-- ============================================== -->
<div class="modal fade" id="modalBuscadorPortadas" tabindex="-1" aria-hidden="true" style="z-index: 1100;">
    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
        <div class="modal-content bg-dark text-white border border-danger">
            <div class="modal-header border-secondary">
                <h5 class="modal-title text-danger fw-bold m-0"><i class="bi bi-globe me-2"></i>Galería Deezer</h5>
                <button type="button" class="btn-close btn-close-white shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-3">
                <div class="row g-2 mb-3">
                    <div class="col-12 col-md-5">
                        <input type="text" id="inputBusquedaWebTitulo" class="form-control bg-secondary text-white border-0 shadow-none" placeholder="Nombre / Título...">
                    </div>
                    <div class="col-12 col-md-5" id="colBusquedaWebArtista">
                        <input type="text" id="inputBusquedaWebArtista" class="form-control bg-secondary text-white border-0 shadow-none" placeholder="Artista(s)...">
                    </div>
                    <div class="col-12 col-md-2">
                        <button class="btn btn-danger fw-bold w-100 shadow-none" onclick="ejecutarBusquedaWeb()"><i class="bi bi-search"></i> Buscar</button>
                    </div>
                </div>
                <div id="resultadosBusquedaWeb" class="row g-2 justify-content-center text-center">
                    <div class="text-secondary my-4">Escribe los datos y presiona buscar.</div>
                </div>
            </div>
        </div>
    </div>
